...
jQuery(document).ready(function() {
	...
	//Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ/ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ ÐºÑƒÐºÐ¸ Ð´Ð»Ñ ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ñ Ð°Ð²Ñ‚Ð¾
...
//ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ ÑÑ‚Ð°Ñ€Ñ‹Ðµ id
	function delete_cookie_old(argument) {
		...
		//Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ/ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ ÐºÑƒÐºÐ¸ Ð´Ð»Ñ Ð»ÑŽÐ±Ð¸Ð¼Ð¾Ð³Ð¾ Ð°Ð²Ñ‚Ð¾
	...
	//Ð¿Ð¾Ð´ÑÐºÐ°Ð·ÐºÐ° Ð±Ð¾Ð»ÑŒÑˆÐµ 3 
	...
	//Ð¾Ð±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ð¿Ð¾ÑÑÐ½ÐµÐ½Ð¸Ðµ
	function compare_auto_update_counter(flag, autoTitle = '', $obj = null) {
		...
		//Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ Ð² ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ñ
		if (flag === 1) {
		...
		} else if (flag === 0) { //ÑƒÐ´Ð°Ð»Ð¸Ñ‚ Ð¸Ð· ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ñ
	...
	(function($) {
		...
		function add_action_compare(argument) {
			//Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ/ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð´Ð»Ñ ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ñ
		...
		//Ð´Ð¾Ð±Ð°Ð²Ð¸Ñ‚ÑŒ/ÑƒÐ´Ð°Ð»Ð¸Ñ‚ÑŒ Ð² Ð»ÑŽÐ±Ð¸Ð¼Ð¾Ðµ
		...
		//ÑÑ‚Ð°Ñ€Ñ‚Ð¾Ð²Ñ‹Ðµ Ð°ÐºÑ‚Ð¸Ð²Ð½Ñ‹Ðµ ÐºÐ»Ð°ÑÑÑ‹ Ñ„Ð°Ð²Ð¾Ñ€Ð¸Ñ‚Ð¾Ð²
		...
		//ÑÑ‚Ð°Ñ€Ñ‚Ð¾Ð²Ñ‹Ðµ Ð°ÐºÑ‚Ð¸Ð²Ð½Ñ‹Ðµ ÐºÐ»Ð°ÑÑÑ‹ ÑÑ€Ð°Ð²Ð½ÐµÐ½Ð¸Ñ
